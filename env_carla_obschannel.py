...
class Gym_CarlaEnv():
    def __init__(self, env_name, symbolic, seed, max_episode_length, action_repeat, bit_depth, input_names):
...
def Env(env_name, symbolic, seed, max_episode_length, action_repeat, bit_depth, input_names):
    env_name = 'carla-v0'
    return Gym_CarlaEnv(env_name, symbolic, seed, max_episode_length, action_repeat, bit_depth, input_names)
